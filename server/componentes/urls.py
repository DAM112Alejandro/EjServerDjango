...
from componentes.views import (
    PilotoListCreate,
    PilotoRetrieveUpdateDestroy,
    PilotoByIngeniero,
    PilotosConMasVictorias,
    EquipoListCreate,
    EquipoRetrieveUpdateDestroy,
    EquipoByNombre,
    EquipoByMotor,
    PilotoByEquipo
)
urlpatterns = [
    ...
    path ('piloto/victorias',PilotosConMasVictorias.as_view() , name='pilotos_victorias'),
